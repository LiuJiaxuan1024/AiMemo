...
Memo 知库：知识空间、文档导入、chunk 预览和知库内检索
知识库图片资源抽取、图片 chunk 统计和 qwen-vl-ocr 图片转文本
...
```json5
{
  ...
  "knowledge": {
    "image_text_extraction": {
      // 默认使用 DashScope qwen-vl-ocr 处理文档图片。
...
- [向量检索](./docs/backend/vector-search.md)
